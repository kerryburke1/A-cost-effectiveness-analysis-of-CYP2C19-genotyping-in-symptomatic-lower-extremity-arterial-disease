...
logHR <- rnorm(1, log(HRmean), SElogHR)
HR_draw <- exp(logHR)
...
#NEED TO MAKE PSA LIKE ABOVE ONE
...
probAtoAH_1_9yr<-rbeta(1,62,3167)
...
probBtoAH_2_45yr<-rbeta(1,83,1351) 
...
probAHtoJ_1_92yr<-rbeta(1,11,72) 
