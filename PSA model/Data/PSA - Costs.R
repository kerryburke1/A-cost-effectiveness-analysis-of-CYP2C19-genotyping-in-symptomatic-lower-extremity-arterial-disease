...
costinflator_2013 <- (1.011*1.009*1.0040*
                                   1.0209*1.0124*1.016*
                                   1.0214*1.0249*1.0258*
                                   1.0732*1.0431)
...
costRivAsp<-((1*6) + costAsp)*rnorm(1,1,0.05102041)
costRivAspAE<-(((2010.35*costinflator_2009_10_to_2024)* (1-(1-0.0315)^(6/23))) + ((111.57*costinflator_2009_10_to_2024)*(1-(1-0.0916)^(6/23))))*rnorm(1,1,0.05102041)
...
trans_cost_mat["RevascCLTI", "Amputation"] <-
  ((1130 * costinflator_2014_15_to_2024) +
     (35804.46 * costinflator_2020_21_to_2024)) *
  rnorm(1, 1, 0.05102041) - cost_E

trans_cost_mat["ReintCLTI", "Amputation"] <-
  ((1130 * costinflator_2014_15_to_2024) +
     (35804.46 * costinflator_2020_21_to_2024)) *
  rnorm(1, 1, 0.05102041) - cost_E

trans_cost_mat["ReintIC", "Amputation"] <-
  ((1130 * costinflator_2014_15_to_2024) +
     (35804.46 * costinflator_2020_21_to_2024)) *
  rnorm(1, 1, 0.05102041) - cost_E
